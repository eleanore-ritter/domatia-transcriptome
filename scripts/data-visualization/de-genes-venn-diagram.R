...
ggVennDiagram(x, 
              label_alpha = 0, 
              label = c("count"),
              category.names = c("588710: C vs D", "588711: C vs D", "Control vs Control", "Domatia vs Domatia")) +
...
ggplot() +
  ...
  # 3. set label layer
  geom_sf_text(aes(label = c("588710: C vs D", "588711: C vs D", "Control vs Control", "Domatia vs Domatia")), data = venn_setlabel(data)) +
